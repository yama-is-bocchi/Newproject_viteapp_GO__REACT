...
const (
	...
	FieldPrice = "price"
	// FieldRecom holds the string denoting the recom field in the database.
	FieldRecom = "recom"
...
// ByRecom orders the results by the recom field.
func ByRecom(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldRecom, opts...).ToFunc()
}
