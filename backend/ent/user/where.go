...
// HasWantlists applies the HasEdge predicate on the "wantlists" edge.
func HasWantlists() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasWantlistsWith applies the HasEdge predicate on the "wantlists" edge with a given conditions (other predicates).
func HasWantlistsWith(preds ...predicate.Wantlist) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newWantlistsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
