...
func (tu *TokenUpdate) SetAccessDate(t time.Time) *TokenUpdate {
	tu.mutation.SetAccessDate(t)
	return tu
}

// SetNillableAccessDate sets the "access_date" field if the given value is not nil.
func (tu *TokenUpdate) SetNillableAccessDate(t *time.Time) *TokenUpdate {
	if t != nil {
		tu.SetAccessDate(*t)
	}
	return tu
...
func (tu *TokenUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := tu.mutation.AccessDate(); ok {
...
// SetAccessDate sets the "access_date" field.
func (tuo *TokenUpdateOne) SetAccessDate(t time.Time) *TokenUpdateOne {
	tuo.mutation.SetAccessDate(t)
	return tuo
}

// SetNillableAccessDate sets the "access_date" field if the given value is not nil.
func (tuo *TokenUpdateOne) SetNillableAccessDate(t *time.Time) *TokenUpdateOne {
	if t != nil {
		tuo.SetAccessDate(*t)
	}
	return tuo
...
func (tuo *TokenUpdateOne) sqlSave(ctx context.Context) (_node *Token, err error) {
	...
	if value, ok := tuo.mutation.AccessDate(); ok {
		_spec.SetField(token.FieldAccessDate, field.TypeTime, value)
	}
